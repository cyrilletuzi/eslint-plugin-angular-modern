...
New rule in `injectionContext` and `recommended` presets:
- [httpresource-in-injection-context](https://github.com/cyrilletuzi/eslint-plugin-angular-modern/blob/main/docs/injection-context/HTTPRESOURCE.md)
...
- [no-ionicmodule](https://github.com/cyrilletuzi/eslint-plugin-angular-modern/blob/main/docs/standalone/NO_IONICMODULE.md)
...
- [no-canload-class](https://github.com/cyrilletuzi/eslint-plugin-angular-modern/blob/main/docs/deprecated/NO_CANLOAD_CLASS.md)
